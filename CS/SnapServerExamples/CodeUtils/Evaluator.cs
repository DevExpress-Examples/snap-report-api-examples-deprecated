...
namespace SnapServerExamples.CodeUtils
{
    ...
    public abstract class SnapExampleCodeEvaluator : ExampleCodeEvaluator
    {
    ...
    public class SnapCSExampleCodeEvaluator : SnapExampleCodeEvaluator
    {
      ...
      "using SnapDocument = DevExpress.Snap.Core.API.SnapDocument;\r\n" +
      "using SnapSparkline = DevExpress.Snap.Core.API.SnapSparkline;\r\n" +
      "using TableRow = DevExpress.XtraRichEdit.API.Native.TableRow;\r\n" +
      "using SnapList=DevExpress.Snap.Core.API.SnapList;\r\n" +
      "namespace SnapCodeResultViewer { \r\n" +
      "public class ExampleItem { \r\n" +
      "        public static void Process(SnapDocumentServer server) { \r\n" +
      "\r\n";
    ...
    public class SnapVbExampleCodeEvaluator : SnapExampleCodeEvaluator
    {
      ...
      "Imports SnapDocument = DevExpress.Snap.Core.API.SnapDocument\r\n" +
      "Imports SnapSparkline = DevExpress.Snap.Core.API.SnapSparkline\r\n" +
      "Imports TableRow = DevExpress.XtraRichEdit.API.Native.TableRow\r\n" +
      "Imports SnapList = DevExpress.Snap.Core.API.SnapList" +
      "Namespace SnapCodeResultViewer\r\n" +
      "	Public Class ExampleItem\r\n" +
      "		Public Shared Sub Process(ByVal server As SnapDocumentServer)\r\n" +
      "\r\n";
    ...
    public abstract class ExampleEvaluatorByTimer : IDisposable
    {
        ...
        {
            ExampleCodeEvaluator snapExampleCodeEvaluator = GetExampleCodeEvaluator(args.Language);
